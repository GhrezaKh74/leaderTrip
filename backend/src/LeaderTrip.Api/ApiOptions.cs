...
public sealed class ApiOptions
{
    ...
    /// تغییر قیمت‌ها عمومی نباشد. احراز هویت کاربر جداگانه ساخته شده
    /// (<c>Endpoints/AuthEndpoints.cs</c>) و این دو عمداً از هم بی‌خبرند: کلید
    /// مدیریتی مال صاحب نمونه است، حساب مال مسافر.
    /// </para>
    /// </remarks>
